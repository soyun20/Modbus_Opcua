...
void ClientMQTT::OnSuccess(void * context, MQTTAsync_successData * response)
{
	...
	_sub_topics.push_back("/opcua/client");
	...
	char *str4 = "/opcua/server";
	char *str5 = "/opcua/client";
	char *str6 = "/opcua/client/readwrite";
	char *str7 = "/modbus/exit";
	char *str8 = "/id";
	char *const array[] = {str1, str2, str3, str4, str5, str6, str7, str8};
