...
readRaw(const UA_HistoryData *data) {
    ...
    for (UA_Int32 i = 0; i < data->dataValuesSize; ++i)
    {
...
int main(int argc, char *argv[]) {
    ...
    UA_StatusCode retval = UA_Client_connect(client, "opc.tcp://10.7.12.201:4880");
    ...
    printf("\nStart historical read (1, \"Objects/testNode1\"):\n");
    UA_NodeId node = UA_NODEID_STRING(1, "Objects/testNode1");
